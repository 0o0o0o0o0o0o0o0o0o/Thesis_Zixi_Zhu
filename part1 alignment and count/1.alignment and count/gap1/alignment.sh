#! /usr/bin/sh
output_dir="/panfs/compbio/users/zzhu244/volumes/GAP1/qc_output/outcome"
mkdir -p $output_dir
input_dir="/panfs/compbio/users/zzhu244/volumes/GAP1/qc_output"
fastp_output_dir="/panfs/compbio/users/zzhu244/volumes/GAP1/qc_output/QC"
